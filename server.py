...
def handleShowList(client):
    ...
    for c in clients:
        ...
        clientAdress=clients[c]["address"][0]
        ...
        if(connected_with):    
            ...
            message=f"{counter}, {c}, {clientAdress}, Connected With {connected_with}, tiul, \n"
        
        else:

            message=f"{counter}, {c}, {clientAdress}, Available, tiul, \n"
...
def acceptConnections():
    ...
    while True:
        ...
        clients[client_name] = {
                ...
                "connected_with" : "",
                "file_name"      : "",
                "file_size"      : 40960000000000000000000
            }
